        ...
        useEffect(() => {
            if (!bLoading && (iPostID != 0)){
                ...
                if (WPConfig.wordpress_url.trim() == ""){
                    ...
                    axios.get(WPConfig.wordpress_url + "/wp-json/wp/v2/posts/" + iPostID + "/?_embed=true").then(result => {
                        setLoading(false);
        ...
        return (
            ...
            { post.excerpt && post.excerpt.rendered && 
                ...
                <div className="readmore-button">
                    <Link className="btn btn-danger btn-sm read-more" to={"/post/" + post.id}>Read more</Link>
                </div>
